...
struct BehaviorFsmOptions {
  ...
  double stop_sign_dist_m = 2.7;          // ... within this of stop_s ...
  ...
  double stop_line_lane_window_m = 15.0;  // a light or sign governs the route
                                          ...
                                          // lane within this of its line (a
                                          // GT light's line is CARLA's stop
                                          // waypoint, up to 8 m before the
                                          // junction lanes it governs)
  // Yielding.
